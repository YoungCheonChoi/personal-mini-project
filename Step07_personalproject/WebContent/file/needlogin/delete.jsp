...
<%@page import="pp.file.dao.FileDao"%>
<%@page import="pp.file.dto.FileDto"%>
...
<%
	...
	if(!dto.getWriter().equals(id)){
		response.sendError(HttpServletResponse.SC_FORBIDDEN, "타인의 파일은 지울 수 없습니다");
		return;  //메서드종료
	}
	...
	//삭제할 파일의 절대 경로 
	//리눅스는 파일 경로 구분자가 슬레쉬, 윈도우는 역슬레쉬를 사용
